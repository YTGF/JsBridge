 ...
 * @date 2019-09-16
 */
public class SystemNestedScrollWebView extends WebView implements NestedScrollingChild {
    ...
    public SystemNestedScrollWebView(Context context) {
        this(context, null);
    }

    public SystemNestedScrollWebView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.webViewStyle);
    }

    public SystemNestedScrollWebView(Context context, AttributeSet attrs, int defStyleAttr) {
                ...
                if (mIsBeingDragged) {
                    ...
                    if (mScrollConsumed[1] == 0 && mScrollOffset[1] == 0) {//WebView内部滑动
                        ...
                        if (!mIsNestScrolling) {
                            ...
                            super.onTouchEvent(MotionEvent.obtain(now, now,
